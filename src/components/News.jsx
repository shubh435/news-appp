  ...
  render() {
    return (
      <>
        ...
        <h1 className='text-center 'style={{marginTop:"90px",marginBottom:"30px"}} >NewsTimes - Top {this.capitalizeFirstLetter(this.props.category)} HeadLines</h1>
            ...
            <div className="row">
              {  this.state.articles.map((e) => {
                return <div className="col-md-4" key={e.url}  >
                  <NewsItem title={e.title ? e.title : ""} description={e.description ? e.description.slice(0, 155) : " "} imageUrl={e.urlToImage ? e.urlToImage : "https://images.hindustantimes.com/img/2022/02/17/1600x900/pjimage_(14)_1645078163307_1645078174372.jpg"} url={e.url} author={e.author ? e.author : "Unknown"} date={e.publishedAt ? e.publishedAt : " "} Source={e.source.name} />
                </div>
              })}
